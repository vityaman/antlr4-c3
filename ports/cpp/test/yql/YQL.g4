// Original source: https://github.com/ydb-platform/ydb/blob/main/yql/essentials/sql/v1/SQLv1Antlr4.g.in
...
in_atom_expr
    ...
    // TODO: resolve ANTLR error: rule in_atom_expr has non-LL(*) decision due to recursive rule
    // invocations reachable from alts 3,8 | LPAREN values_stmt RPAREN
    | value_constructor
    | bitcast_expr
    | list_literal
    | dict_literal
...
row_pattern_primary
    ...
    //TODO This rule accepts spaces between brace and minus sign, i.e: {   -  S2 - } that is not supposed to. Handle this case in https://st.yandex-team.ru/YQL-16227
    | row_pattern_permute
    ;
...
/// window function supp differ from 2003 for resolve conflict
null_treatment
    : RESPECT NULLS
    | IGNORE NULLS
    ;
...
// TODO: [fatal] rule named_nodes_stmt has non-LL(*) decision due to recursive rule invocations
// reachable from alts 1,3 named_nodes_stmt: bind_parameter_list EQUALS (expr | subselect_stmt |
// values_stmt | LPAREN values_stmt RPAREN);
named_nodes_stmt
...
// fragment STRING_CORE_SINGLE: ~(QUOTE_SINGLE | BACKSLASH) | (BACKSLASH .); fragment
// STRING_CORE_DOUBLE: ~(QUOTE_DOUBLE | BACKSLASH) | (BACKSLASH .);

// fragment STRING_SINGLE: (QUOTE_SINGLE STRING_CORE_SINGLE* QUOTE_SINGLE);
fragment STRING_DOUBLE
    : (QUOTE_DOUBLE ('a' ..'z' | 'A' ..'Z')* QUOTE_DOUBLE)
    ;
